  ...
  return (
    <section className="section-shell pb-24">
      <div className="container-shell">
        <div className="panel premium-border relative overflow-hidden rounded-[36px] border border-red-400/20 bg-gradient-to-br from-red-500/18 via-slate-950 to-slate-950 p-8 sm:p-10 lg:p-14">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-end">
            <div className="space-y-5">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="stat-chip bg-white/10 text-white">
